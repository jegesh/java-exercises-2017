...
//    private String dbName = "il/co/electriccollege/restaurant/dishes";
//
////    private String dbHost = "localhost";
////    //  Database credentials
////    private String USER = "elecjava2017";
////    private String PASS = null;
////    private String DB_URL = "electric-java-2017.ceavgnl7zcnr.eu-west-2.rds.amazonaws.com";
...
//        dbName = properties.getProperty("dishes.db.name");
//        dbHost = properties.getProperty("dishes.db.hostname");
//        USER = properties.getProperty("dishes.db.username");
//        PASS = properties.getProperty("dishes.db.password");
//        DB_URL = String.format(DB_URL, dbHost, dbName);
//    }
//
